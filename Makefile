LDFLAGS += -X "github.com/G-Node/gogs/internal/setting.BuildTime=$(shell date -u '+%Y-%m-%d %I:%M:%S %Z')"
LDFLAGS += -X "github.com/G-Node/gogs/internal/setting.BuildCommit=$(shell git rev-parse HEAD)"
